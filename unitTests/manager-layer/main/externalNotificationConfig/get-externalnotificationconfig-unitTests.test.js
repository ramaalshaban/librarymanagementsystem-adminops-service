...
describe("GetExternalNotificationConfig", () => {
  let ControllerClass;
  let req;
  ...
  beforeEach(() => {
    ...
    ControllerClass = proxyquire(
      "../../../../src/manager-layer/main/ExternalNotificationConfig/get-externalnotificationconfig",
      {
  ...
  it("should initialize controller with correct base properties", () => {
    ...
    expect(instance.options.name).to.equal("getExternalNotificationConfig");
