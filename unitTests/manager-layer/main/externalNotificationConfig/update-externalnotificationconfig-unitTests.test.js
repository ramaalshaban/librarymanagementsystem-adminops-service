...
describe("UpdateExternalNotificationConfig", () => {
  let ControllerClass;
  let req;
  ...
  beforeEach(() => {
    ...
    ControllerClass = proxyquire(
      "../../../../src/manager-layer/main/ExternalNotificationConfig/update-externalnotificationconfig",
      {
  ...
  it("should initialize controller with correct base properties", () => {
    ...
    expect(instance.options.name).to.equal("updateExternalNotificationConfig");
