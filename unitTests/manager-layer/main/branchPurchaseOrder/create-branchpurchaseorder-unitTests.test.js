...
describe("CreateBranchPurchaseOrder", () => {
  let ControllerClass;
  let req;
  ...
  beforeEach(() => {
    ...
    ControllerClass = proxyquire(
      "../../../../src/manager-layer/main/BranchPurchaseOrder/create-branchpurchaseorder",
      {
  ...
  it("should initialize controller with correct base properties", () => {
    ...
    expect(instance.options.name).to.equal("createBranchPurchaseOrder");
