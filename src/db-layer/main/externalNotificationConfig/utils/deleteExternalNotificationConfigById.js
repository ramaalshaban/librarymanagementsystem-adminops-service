...
const deleteExternalNotificationConfigById = async (id) => {
  try {
    if (typeof id === "object") {
      id = id.id;
    }
    ...
    const deletedDoc = await ExternalNotificationConfig.findOneAndUpdate(
...
module.exports = deleteExternalNotificationConfigById;
