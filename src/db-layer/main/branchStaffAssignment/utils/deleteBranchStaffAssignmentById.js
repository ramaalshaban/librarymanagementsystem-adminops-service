...
const deleteBranchStaffAssignmentById = async (id) => {
  try {
    if (typeof id === "object") {
      id = id.id;
    }
    ...
    const deletedDoc = await BranchStaffAssignment.findOneAndUpdate(
...
module.exports = deleteBranchStaffAssignmentById;
