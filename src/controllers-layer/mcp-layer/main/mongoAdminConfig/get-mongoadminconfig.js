...
class GetMongoAdminConfigMcpController extends AdminOpsMcpController {
  constructor(params) {
    super("getMongoAdminConfig", "getmongoadminconfig", params);
    this.dataName = "mongoAdminConfig";
    this.crudType = "get";
  }

  createApiManager() {
    return new GetMongoAdminConfigManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: GetMongoAdminConfigMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      mcpParams.headers = headers;
      const getMongoAdminConfigMcpController =
        new GetMongoAdminConfigMcpController(mcpParams);
      try {
        const result = await getMongoAdminConfigMcpController.processRequest();
        //return GetMongoAdminConfigMcpController.getOutputSchema().parse(result);
        return {
          content: [
            {
              type: "text",
