...
class DeleteIssueEscalationMcpController extends AdminOpsMcpController {
  constructor(params) {
    super("deleteIssueEscalation", "deleteissueescalation", params);
    this.dataName = "issueEscalation";
    this.crudType = "delete";
  }

  createApiManager() {
    return new DeleteIssueEscalationManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    description:
      "Close, resolve, or deactivate an escalation/issue (soft delete).",
    parameters: DeleteIssueEscalationMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      mcpParams.headers = headers;
      const deleteIssueEscalationMcpController =
        new DeleteIssueEscalationMcpController(mcpParams);
      try {
        const result =
          await deleteIssueEscalationMcpController.processRequest();
        //return DeleteIssueEscalationMcpController.getOutputSchema().parse(result);
        return {
          content: [
            {
              type: "text",
