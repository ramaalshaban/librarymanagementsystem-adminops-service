...
class GetIssueEscalationMcpController extends AdminOpsMcpController {
  constructor(params) {
    super("getIssueEscalation", "getissueescalation", params);
    this.dataName = "issueEscalation";
    this.crudType = "get";
  }

  createApiManager() {
    return new GetIssueEscalationManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: GetIssueEscalationMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      mcpParams.headers = headers;
      const getIssueEscalationMcpController =
        new GetIssueEscalationMcpController(mcpParams);
      try {
        const result = await getIssueEscalationMcpController.processRequest();
        //return GetIssueEscalationMcpController.getOutputSchema().parse(result);
        return {
          content: [
            {
              type: "text",
