...
console.log("Starting librarymanagementsystem-adminops-service service...");
...
const start = async () => {
  process.title = "node-librarymanagementsystem-adminops-service";
  ...
  try {
    ...
    await setRedisData(
      "librarymanagementsystem-adminops-service:start",
      today.toUTCString(),
    );
    console.log(
      "Service start datetime is written to Redis key librarymanagementsystem-adminops-service:start",
      today.toUTCString(),
    );
  } catch (err) {
  ...
  console.log(
    "librarymanagementsystem-adminops-service is listening HTTP/REST port " +
...
/* starting the server librarymanagementsystem-adminops-service .... */
start();
