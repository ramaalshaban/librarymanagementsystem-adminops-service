...
const {
  ...
  branchStaffAssignmentRouter,
  issueEscalationRouter,
  mongoAdminConfigRouter,
  externalNotificationConfigRouter,
  systemBackupAuditRouter,
  branchPurchaseOrderRouter,
  tregtRouter,
  adminOpsShareTokenRouter,
} = require("restLayer");

app.use("", branchStaffAssignmentRouter);
app.use("", issueEscalationRouter);
app.use("", mongoAdminConfigRouter);
app.use("", externalNotificationConfigRouter);
app.use("", systemBackupAuditRouter);
app.use("", branchPurchaseOrderRouter);
app.use("", tregtRouter);
app.use("", adminOpsShareTokenRouter);
...
app.get("/getPostmanCollection", (req, res) => {
  const filePath = path.join(
    __dirname,
    "librarymanagementsystem-adminOps-postman-collection.json",
  );
  console.log("Downloading Postman Collection from:", filePath);
  res.setHeader("Content-Type", "application/json");
  res.setHeader(
    "Content-Disposition",
    'attachment; filename="librarymanagementsystem-adminOps-postman-collection.json"',
  );
