...
const adminOpsPackage = grpcObject.adminOps;

const server = new grpc.Server();

function helloMessage(call, callback) {
  callback(null, {
    hello: "hello, this is librarymanagementsystem-adminops-service",
  });
}

const {} = require("./controllers-layer/grpc-layer");

server.addService(adminOpsPackage.adminOpsService.service, {
  helloMessage,
  ...sessionRouter,
});
